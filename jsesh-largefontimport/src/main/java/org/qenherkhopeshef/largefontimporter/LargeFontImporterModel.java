...
public class LargeFontImporterModel extends AbstractTableModel {
    ...
    private HashMap<Integer, String> fontCodes = new HashMap<>();

    private HashSet<Integer> fullHeightSigns = new HashSet<>();
    ...
    public int getRowCount() {
        ...
        // Le problème est que certaines versions de java ne peuvent pas indiquer quand
        // un signe appartient à
     ...
     * 2ieme :l'échelle Ensuite, liste : number GardinerCode
     *
     * @throws IOException
     */
    public void saveFile(OutputStream out) throws IOException {
        ...
        Iterator<Integer> it = fontCodes.keySet().iterator();
        while (it.hasNext()) {
    ...
    public void exportSigns() throws DuplicateEntriesException {
        ...
        Iterator<String> it = fontCodes.values().iterator();
        while (it.hasNext()) {
    ...
    public String getColumnName(int column) {
        String[] names = { Messages.getString("LargeFontImporterModel.POSITION"), //$NON-NLS-1$
                Messages.getString("LargeFontImporterModel.GLYPHE"), //$NON-NLS-1$
                Messages.getString("LargeFontImporterModel.MANUEL_DE_CODAGE"), //$NON-NLS-1$
